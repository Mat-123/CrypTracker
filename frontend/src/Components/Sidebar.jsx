            ...
            <Link className="navbar-brand text-start fs-3 mb-3" to="/">
                ...
                {user && user.role === 'premium' ? (
                  <>
                    ...
                    <div className="row mb-3 d-flex flex-row">
                    <Link className="nav-link text-start fs-5 d-flex align-items-center" aria-current="page" to="/download-report">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#F0BB6C" className="bi bi-download me-2" viewBox="0 0 16 16">
